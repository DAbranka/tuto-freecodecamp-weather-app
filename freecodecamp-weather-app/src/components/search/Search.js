...
const Search = ({ onSearchChange }) => {
  // onSearchChange = le moment ou la valeur de notre rech' change
  ...
  const loadOptions = (inputValue) => {
    //inputValue = la valeur tapé dans la barre qui servira de requete au données voulu
  ...
  const handleOnChange = (searchData) => {
    // handleOnChange function qui contiendra  en parametre "searchData" qui récupère les données qu'on rentre dans "AsyncPaginate" la barre de recherche.
